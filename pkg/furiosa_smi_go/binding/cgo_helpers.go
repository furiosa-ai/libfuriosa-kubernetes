...
// Ref returns the underlying reference to C object or nil if struct is nil.
func (x *FuriosaSmiVersion) Ref() *C.FuriosaSmiVersion {
	if x == nil {
		return nil
	}
	return x.ref2c989684
}

// Free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func (x *FuriosaSmiVersion) Free() {
	if x != nil && x.allocs2c989684 != nil {
		x.allocs2c989684.(*cgoAllocMap).Free()
		x.ref2c989684 = nil
	}
}

// NewFuriosaSmiVersionRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func NewFuriosaSmiVersionRef(ref unsafe.Pointer) *FuriosaSmiVersion {
	if ref == nil {
		return nil
	}
	obj := new(FuriosaSmiVersion)
	obj.ref2c989684 = (*C.FuriosaSmiVersion)(unsafe.Pointer(ref))
	return obj
}

// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *FuriosaSmiVersion) PassRef() (*C.FuriosaSmiVersion, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.ref2c989684 != nil {
		return x.ref2c989684, nil
	}
	mem2c989684 := allocFuriosaSmiVersionMemory(1)
	ref2c989684 := (*C.FuriosaSmiVersion)(mem2c989684)
	allocs2c989684 := new(cgoAllocMap)
	allocs2c989684.Add(mem2c989684)

	var carch_allocs *cgoAllocMap
	ref2c989684.arch, carch_allocs = (C.FuriosaSmiArch)(x.Arch), cgoAllocsUnknown
	allocs2c989684.Borrow(carch_allocs)

	var cmajor_allocs *cgoAllocMap
	ref2c989684.major, cmajor_allocs = (C.uint32_t)(x.Major), cgoAllocsUnknown
	allocs2c989684.Borrow(cmajor_allocs)

	var cminor_allocs *cgoAllocMap
	ref2c989684.minor, cminor_allocs = (C.uint32_t)(x.Minor), cgoAllocsUnknown
	allocs2c989684.Borrow(cminor_allocs)

	var cpatch_allocs *cgoAllocMap
	ref2c989684.patch, cpatch_allocs = (C.uint32_t)(x.Patch), cgoAllocsUnknown
	allocs2c989684.Borrow(cpatch_allocs)

	var cmetadata_allocs *cgoAllocMap
	ref2c989684.metadata, cmetadata_allocs = *(*[96]C.char)(unsafe.Pointer(&x.Metadata)), cgoAllocsUnknown
	allocs2c989684.Borrow(cmetadata_allocs)

	x.ref2c989684 = ref2c989684
	x.allocs2c989684 = allocs2c989684
	return ref2c989684, allocs2c989684

}

// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x FuriosaSmiVersion) PassValue() (C.FuriosaSmiVersion, *cgoAllocMap) {
	if x.ref2c989684 != nil {
		return *x.ref2c989684, nil
	}
	ref, allocs := x.PassRef()
	return *ref, allocs
...
// Deref uses the underlying reference to C object and fills the wrapping struct with values.
// Do not forget to call this method whether you get a struct for C object and want to read its values.
func (x *FuriosaSmiVersion) Deref() {
	if x.ref2c989684 == nil {
		return
	}
	x.Arch = (FuriosaSmiArch)(x.ref2c989684.arch)
	x.Major = (uint32)(x.ref2c989684.major)
	x.Minor = (uint32)(x.ref2c989684.minor)
	x.Patch = (uint32)(x.ref2c989684.patch)
	x.Metadata = *(*[96]byte)(unsafe.Pointer(&x.ref2c989684.metadata))
}
...
func (x *FuriosaSmiDeviceInfo) Deref() {
	...
	x.FirmwareVersion = *NewFuriosaSmiVersionRef(unsafe.Pointer(&x.refde203aa5.firmware_version))
	x.DriverVersion = *NewFuriosaSmiVersionRef(unsafe.Pointer(&x.refde203aa5.driver_version))
}
...
// unpackA24FuriosaSmiVersion transforms a sliced Go data structure into plain C format.
func unpackA24FuriosaSmiVersion(x [24]FuriosaSmiVersion) (unpacked [24]C.FuriosaSmiVersion, allocs *cgoAllocMap) {
	allocs = new(cgoAllocMap)
	defer runtime.SetFinalizer(allocs, func(a *cgoAllocMap) {
		go a.Free()
	})

	mem0 := allocA24FuriosaSmiVersionMemory(1)
	allocs.Add(mem0)
	v0 := (*[24]C.FuriosaSmiVersion)(mem0)
	for i0 := range x {
		allocs0 := new(cgoAllocMap)
		v0[i0], allocs0 = x[i0].PassValue()
		allocs.Borrow(allocs0)
	}
	unpacked = *(*[24]C.FuriosaSmiVersion)(mem0)
	return
}

// packA24FuriosaSmiVersion reads sliced Go data structure out from plain C format.
func packA24FuriosaSmiVersion(v *[24]FuriosaSmiVersion, ptr0 *[24]C.FuriosaSmiVersion) {
	for i0 := range v {
		ptr1 := ptr0[i0]
		v[i0] = *NewFuriosaSmiVersionRef(unsafe.Pointer(&ptr1))
	}
}
...
func (x *FuriosaSmiDriverInfo) PassRef() (*C.FuriosaSmiDriverInfo, *cgoAllocMap) {
	...
	ref26157232.driver_info, cdriver_info_allocs = unpackA24FuriosaSmiVersion(x.DriverInfo)
...
func (x *FuriosaSmiDriverInfo) Deref() {
	...
	packA24FuriosaSmiVersion(&x.DriverInfo, (*[24]C.FuriosaSmiVersion)(unsafe.Pointer(&x.ref26157232.driver_info)))
}
