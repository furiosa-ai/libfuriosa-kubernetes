...
// FuriosaSmiInit function as declared in furiosa_smi_go/furiosa_smi.h:147
...
// FuriosaSmiShutdown function as declared in furiosa_smi_go/furiosa_smi.h:149
...
// FuriosaSmiGetDeviceHandles function as declared in furiosa_smi_go/furiosa_smi.h:151
func FuriosaSmiGetDeviceHandles(outHandles *FuriosaSmiDeviceHandles) FuriosaSmiReturnCode {
	coutHandles, coutHandlesAllocMap := outHandles.PassRef()
...
// FuriosaSmiGetDeviceHandleByUuid function as declared in furiosa_smi_go/furiosa_smi.h:153
...
// FuriosaSmiGetDeviceHandleBySerial function as declared in furiosa_smi_go/furiosa_smi.h:156
...
// FuriosaSmiGetDeviceHandleByBdf function as declared in furiosa_smi_go/furiosa_smi.h:159
...
// FuriosaSmiGetDeviceInfo function as declared in furiosa_smi_go/furiosa_smi.h:162
func FuriosaSmiGetDeviceInfo(handle FuriosaSmiDeviceHandle, outDeviceInfo *FuriosaSmiDeviceInfo) FuriosaSmiReturnCode {
	...
	coutDeviceInfo, coutDeviceInfoAllocMap := outDeviceInfo.PassRef()
...
// FuriosaSmiGetDeviceFiles function as declared in furiosa_smi_go/furiosa_smi.h:165
func FuriosaSmiGetDeviceFiles(handle FuriosaSmiDeviceHandle, outDeviceFiles *FuriosaSmiDeviceFiles) FuriosaSmiReturnCode {
	chandle, chandleAllocMap := (C.FuriosaSmiDeviceHandle)(handle), cgoAllocsUnknown
	coutDeviceFiles, coutDeviceFilesAllocMap := outDeviceFiles.PassRef()
...
// FuriosaSmiGetDeviceCoreStatus function as declared in furiosa_smi_go/furiosa_smi.h:168
func FuriosaSmiGetDeviceCoreStatus(handle FuriosaSmiDeviceHandle, outCoreStatus *FuriosaSmiCoreStatuses) FuriosaSmiReturnCode {
	chandle, chandleAllocMap := (C.FuriosaSmiDeviceHandle)(handle), cgoAllocsUnknown
	coutCoreStatus, coutCoreStatusAllocMap := outCoreStatus.PassRef()
...
// FuriosaSmiGetDeviceLiveness function as declared in furiosa_smi_go/furiosa_smi.h:171
...
// FuriosaSmiGetDeviceErrorInfo function as declared in furiosa_smi_go/furiosa_smi.h:174
func FuriosaSmiGetDeviceErrorInfo(handle FuriosaSmiDeviceHandle, outErrorInfo *FuriosaSmiDeviceErrorInfo) FuriosaSmiReturnCode {
	chandle, chandleAllocMap := (C.FuriosaSmiDeviceHandle)(handle), cgoAllocsUnknown
	coutErrorInfo, coutErrorInfoAllocMap := outErrorInfo.PassRef()
...
// FuriosaSmiGetDriverInfo function as declared in furiosa_smi_go/furiosa_smi.h:177
func FuriosaSmiGetDriverInfo(outDriverInfo *FuriosaSmiDriverInfo) FuriosaSmiReturnCode {
	coutDriverInfo, coutDriverInfoAllocMap := outDriverInfo.PassRef()
...
// FuriosaSmiGetDeviceUtilization function as declared in furiosa_smi_go/furiosa_smi.h:179
func FuriosaSmiGetDeviceUtilization(handle FuriosaSmiDeviceHandle, outUtilizationInfo *FuriosaSmiDeviceUtilization) FuriosaSmiReturnCode {
	chandle, chandleAllocMap := (C.FuriosaSmiDeviceHandle)(handle), cgoAllocsUnknown
	coutUtilizationInfo, coutUtilizationInfoAllocMap := outUtilizationInfo.PassRef()
...
// FuriosaSmiGetDevicePowerConsumption function as declared in furiosa_smi_go/furiosa_smi.h:182
func FuriosaSmiGetDevicePowerConsumption(handle FuriosaSmiDeviceHandle, outPowerConsumption *FuriosaSmiDevicePowerConsumption) FuriosaSmiReturnCode {
	chandle, chandleAllocMap := (C.FuriosaSmiDeviceHandle)(handle), cgoAllocsUnknown
	coutPowerConsumption, coutPowerConsumptionAllocMap := outPowerConsumption.PassRef()
...
// FuriosaSmiGetDeviceTemperature function as declared in furiosa_smi_go/furiosa_smi.h:185
func FuriosaSmiGetDeviceTemperature(handle FuriosaSmiDeviceHandle, outTemperature *FuriosaSmiDeviceTemperature) FuriosaSmiReturnCode {
	chandle, chandleAllocMap := (C.FuriosaSmiDeviceHandle)(handle), cgoAllocsUnknown
	coutTemperature, coutTemperatureAllocMap := outTemperature.PassRef()
...
// FuriosaSmiGetDeviceToDeviceLinkType function as declared in furiosa_smi_go/furiosa_smi.h:188
