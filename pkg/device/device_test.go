...
func TestCollectDevices(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			inputPaths: []string{
				Abs("../../testdata/device/testdata/test-0/dev/npu0"),
				Abs("../../testdata/device/testdata/test-0/dev/npu0pe0"),
				Abs("../../testdata/device/testdata/test-0/dev/npu0pe1"),
				Abs("../../testdata/device/testdata/test-0/dev/npu0pe0-1"),
			},
			expectedCoresLen:       2,
		...
		},
		{
			...
			inputPaths: []string{
				Abs("../../testdata/device/testdata/test-0/dev/npu1"),
				Abs("../../testdata/device/testdata/test-0/dev/npu1pe0"),
				Abs("../../testdata/device/testdata/test-0/dev/npu1pe1"),
				Abs("../../testdata/device/testdata/test-0/dev/npu1pe0-1"),
			},
			expectedCoresLen:       2,
			expectedDeviceFilesLen: 4,
		},
...
func TestNewDevice(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expectedResult: &device{
				deviceIndex: 0,
				devRoot:     "../../testdata/device/testdata/test-0/dev",
				sysRoot:     "../../testdata/device/testdata/test-0/sys",
				arch:        ArchWarboy,
				...
				devFiles: []DeviceFile{
					&deviceFile{
						...
						path:       Abs("../../testdata/device/testdata/test-0/dev/npu0"),
					...
					&deviceFile{
						...
						path:       Abs("../../testdata/device/testdata/test-0/dev/npu0pe0"),
					...
					&deviceFile{
						...
						path:       Abs("../../testdata/device/testdata/test-0/dev/npu0pe1"),
						deviceMode: DeviceModeSingle,
					},
					&deviceFile{
						index: 0,
						...
						path:       Abs("../../testdata/device/testdata/test-0/dev/npu0pe0-1"),
			...
			expectedResult: &device{
				...
				devFiles: []DeviceFile{
					&deviceFile{
						...
						path:       Abs("../../testdata/device/testdata/test-0/dev/npu1"),
						deviceMode: DeviceModeMultiCore,
					},
					&deviceFile{
						index: 1,
						...
						path:       Abs("../../testdata/device/testdata/test-0/dev/npu1pe0"),
						deviceMode: DeviceModeSingle,
					},
					&deviceFile{
						index: 1,
						...
						path:       Abs("../../testdata/device/testdata/test-0/dev/npu1pe1"),
						deviceMode: DeviceModeSingle,
					},
					&deviceFile{
						index: 1,
						...
						path:       Abs("../../testdata/device/testdata/test-0/dev/npu1pe0-1"),
						deviceMode: DeviceModeFusion,
					},
				},
			},
